...
namespace Projeto_Financeiro.Application.Services
{
    public class RelatorioCategoriaExcelService : IRelatorioCategoriaExcelService
    {
        public void GerarRelatorioByCategoriaExcel(List<RelatorioCategoria> relatorio, DateTime dataInicio, DateTime dataFim)
        {
            ...
            var nomeArquivo = $"RelatorioPorCategoria_{dataInicio:yyyyMMdd}_{dataFim:yyyyMMdd}_{segundoAtual}.xlsx";
            var caminho = Path.Combine("C:\\Users\\Andrea\\Desktop\\Rafael(Melhor Genro do Mundo)\\Repository", nomeArquivo); // ajuste para onde quer salvar
